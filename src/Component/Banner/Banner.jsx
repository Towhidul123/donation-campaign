    ...
    return (
        <div className="">
            ...
            <div className="flex justify-center items-center  ">
                <div className="relative flex h-10 w-full min-w-[200px] max-w-[24rem] bg-white rounded-lg">
                    <input
                        type="email"
                    ...
                    />
                    <button
                        className="!absolute right-1 top-1 z-10 select-none rounded  bg-red-500 py-2 px-4 text-center align-middle  text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none peer-placeholder-shown:pointer-events-none peer-placeholder-shown:bg-blue-gray-500 peer-placeholder-shown:opacity-50 peer-placeholder-shown:shadow-none"
                        type="button"
            ...
            <div className="absolute h-full w-full inset-0 -z-10 ">
                <div className="hero z-10 min-h-[600px]" style={{ backgroundImage: 'url(https://i.ibb.co/8NgbD08/fc1f79e18cdc1a12320b9b10ec3e253d.jpg)' }}>
                    ...
                    <div className=" text-center text-neutral-content">
                        <div className="">
                            <h1 className="mb-5 text-5xl font-bold mt-10">I Grow By Helping People In Need</h1>
            ...
            <div className="absolute min-h-[600px] bg-white h-full inset-0 w-full bg-opacity-60  -z-10"></div>
